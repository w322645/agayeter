...
exports.run = async (client, message, args) => {
   if(db.fetch(`bıçak_${message.author.id}`) == undefined) {var baltavar = "0"}
    ...
    .setTitle('Eşya yok!')
    .setDescription(`Elinde Bıçak Eşyası olmadığından kullanamazsın!`)
...
message.channel.send(new Discord.MessageEmbed().setColor("#36393f").setDescription(`🔪 Bıçak Vurulan Kişiden${espri}<:tl:891668420066672650> Para Çıktı`));
}
